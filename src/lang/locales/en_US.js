...
module.exports = {
  /* 01.General */
  "general.copyright": "Online Sagra © 2020 All Rights Reserved.",

  "homepage.h1": "Welcome to the first Online Sagra: Venice 2020!",
  "homepage.lead": "In Venice as in many other Italian cities, sagra represents a special moment for the community: it is an event where the symbolism of a celebration turns into a moment of sociality and fun, sharing culture as well as food and wine tradition.",
  "homepage.sublead": "In the virtual sagra, open for free to all of you, you can live the atmosphere and participate in the same activities as a sagra in the field in Venice ... directly from your home! It is an opportunity for socializing and fun, without forgetting those who currently struggle and suffer from the pandemic emergency: traveling through the virtual square, you can help support artisans, restaurateurs and local solidarity projects, to help Venice and his community in this difficult moment.",
  "homepage.h2": "How does it work?",
  "homepage.h2-lead": "Explore the virtual square or scroll the menu on the side to choose the activities that interest you most!",
  "homepage.h2-sublead": "Meet people from Venice and from all over the world, dance with the music of the main stage, discover curiosities about Venice and &order a good meal or a nice gadget: they will not be real purchases, but donations aimed at supporting our partner's local activities!",
  "homepage.discover-button": "Discover Sagra",
  "homepage.discover-card-title": "Discover Sagra",
  "homepage.discover-card-body": "Sagra is not only a concept, is a sharing moment and a way of living.",
  "homepage.stage-card-title": "Visit main stage",
  "homepage.stage-card-body": "Enjoy the music streamed live, dance and meet new people! Enjoy the party!",
  "homepage.camp-card-title": "Campo",
  "homepage.camp-card-body": "Discover places",
  "homepage.bar-card-title": "Visit the Bar",
  "homepage.bar-card-body": "Select drinks and dishes and the amount you will pay for them will be donated to support bars, 'bacari', wine bars, restaurants and typical trattorias in Venice.",
  "homepage.fiera-card-title": "Visit Fiera",
  "homepage.fiera-card-body": "We are all small businesses, living in challenging times preserving ancient and beautiful traditions. Visit our stands and take look to our accomplishments!",
  ...
  "lottery.name": "Name",
  "lottery.email": "Email",
  "lottery.step1": "Donate",
  "lottery.step-name-1": "Amount",
  "lottery.step-name-2": "Name",
  "lottery.step-name-3": "Email",
  "lottery.step-desc-1": "Every penny matters!",
  "lottery.step-desc-2": "Tell us your name!",
  "lottery.step-desc-3": "What is your email?",
  "lottery.content-1": "Step content for first step.",
  "lottery.content-2": "Step content for second step.",
  "lottery.content-3": "Last step content!",
  "lottery.content-thanks": "Thank You!",
  "lottery.next": "Next",
  "lottery.prev": "Back",
  "lottery.registered": "Thank you for your donation!",
  "lottery.async": "Async save for 3 seconds!",

  "lottery.donations": "Total donations this week",
  "lottery.latest-donations": "Latest donations",
