...
module.exports = {
  ...
  "homepage.h1": "Welcome to the Online Sagra",
  "homepage.lead": "Have fun, be in contact with your friends and make new friends. Visit the different stands of the sagra and contribute with local artisan from Venice!",
  "homepage.discover-button": "Discover places",
  "homepage.discover-card-title": "Discovery",
  "homepage.discover-card-body": "Discover places to visit in Venice",
  "homepage.stage-card-title": "Stage",
  "homepage.stage-card-body": "Discover places",
  "homepage.camp-card-title": "Camp",
  "homepage.camp-card-body": "Discover places",
  "homepage.bar-card-title": "Bar",
  "homepage.bar-card-body": "Discover places",
  "homepage.fiera-card-title": "Fiera",
  "homepage.fiera-card-body": "Discover places",
  "homepage.lottery-card-title": "Lottery",
  "homepage.lottery-card-body": "Discover places",
